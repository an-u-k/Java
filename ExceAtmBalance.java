...
public class ExceAtmBalance {

	public static void main(String[] args) throws ExceptionInvalidAtm {
	...
	private static void menu() throws ExceptionInvalidAtm {
		// TODO Auto-generated method stub
		Scanner input = new Scanner(System.in);
		int balanceAmount = 0;
		...
		do {
			...
			case 3: {
				...
				/*
				 * // balancechecking if (balanceAmount - 5000 < 0)
				 * System.out.println("Total Balance amount is less than 5000"); else
	...
	public static void displayBalance(int balanceAmount) throws ExceptionInvalidAtm {
		// TODO Auto-generated method stub
		if (balanceAmount - 5000 < 0) {
			throw new ExceptionInvalidAtm();
		} else
			System.out.println("Available bal " + (balanceAmount - 5000));
		System.out.println("ledger Amount is:" + (balanceAmount));
